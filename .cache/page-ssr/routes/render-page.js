...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2516);
...
// EXTERNAL MODULE: external "/Users/gray/Documents/codingMain/template-site/node_modules/react/index.js"
var index_js_ = __webpack_require__(2516);
...
/* harmony export */   "dl": () => (/* binding */ useThemedStylesWithMdx)
/* harmony export */ });
/* unused harmony exports defaultMdxComponents, themed */
/* harmony import */ var _theme_ui_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2396);
/* harmony import */ var _theme_ui_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3431);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2516);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
var themed = function themed(key) {
  return function (theme) {
    return (0,_theme_ui_css__WEBPACK_IMPORTED_MODULE_1__/* .css */ .iv)((0,_theme_ui_css__WEBPACK_IMPORTED_MODULE_1__/* .get */ .U2)(theme, "styles." + key))(theme);
  };
};
...
var createThemedComponent = function createThemedComponent(name, variant) {
  ...
  var component = function component(props) {
    ...
    return (0,_theme_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .jsx */ .tZ)(name, _extends({}, props, {
...
function wrapComponent(value, key) {
  var component = function component(props) {
    return (0,_theme_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .jsx */ .tZ)(value, _extends({}, props, {
      css: themed(key)
    }));
  };
...
var React = _interopRequireWildcard(__webpack_require__(2516));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(2516);
...
var _react = _interopRequireDefault(__webpack_require__(2516));
...
exports.components={"component---node-modules-lekoarts-gatsby-theme-cara-src-templates-cara-tsx":()=>__webpack_require__.e(/* import() | component---node-modules-lekoarts-gatsby-theme-cara-src-templates-cara-tsx */ 527).then(__webpack_require__.bind(__webpack_require__, 282)),"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 2513))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-theme-ui',plugin:__webpack_require__(7972),options:{"plugins":[]}},{name:'@lekoarts/gatsby-theme-cara',plugin:__webpack_require__(8924),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"name":"Cara - @lekoarts/gatsby-theme-cara","short_name":"Cara","description":"Playful and Colorful One-Page portfolio featuring Parallax effects and animations","start_url":"/","background_color":"#141821","display":"standalone","icons":[{"src":"/android-chrome-192x192.png","sizes":"192x192","type":"image/png"},{"src":"/android-chrome-512x512.png","sizes":"512x512","type":"image/png"}],"legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":null}},{name:'default-site-plugin',plugin:__webpack_require__(2695),options:{"plugins":[]}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const onRenderBody=({setHeadComponents})=>{setHeadComponents([/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("link",{key:"icons-preload",rel:"preload",href:(0,gatsby__WEBPACK_IMPORTED_MODULE_1__.withPrefix)(`/icons.svg`),as:"image",type:"image/svg+xml"})]);};
...
const Root=({children})=>{const themeUiConfig=configOptions();const{preset,prismPreset}=themeUiConfig;const theme=preset.default||preset;const themeWithPrism=(0,theme_ui_core_esm/* merge */.TS)(theme,{styles:{pre:prismPreset}});const fullTheme=(0,theme_ui_core_esm/* merge */.TS)(themeWithPrism,gatsby_plugin_theme_ui);return/*#__PURE__*/index_js_default().createElement(ThemeProvider,{theme:fullTheme},/*#__PURE__*/index_js_default().createElement(lib/* MDXProvider */.Zo,{components:(0,theme_ui_mdx_esm/* useThemedStylesWithMdx */.dl)((0,lib/* useMDXComponents */.ah)(src_components))},children));};const WrapRootElement=({element})=>{return/*#__PURE__*/index_js_default().createElement(Root,null,element);};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(2516),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/gray/Documents/codingMain/template-site/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/gray/Documents/codingMain/template-site/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/gray/Documents/codingMain/template-site/node_modules/react/index.js");
...
/******/ 			return "" + {"218":"component---src-pages-404-tsx","527":"component---node-modules-lekoarts-gatsby-theme-cara-src-templates-cara-tsx"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(2516);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1571);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(6692);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
